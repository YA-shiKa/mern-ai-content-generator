                  ...
                  <div className="slider-container">
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ContentCrafter AI revolutionizes the way you create content.
                    ...
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          stories, ContentCrafter AI tailors content to your specific
                    ...
                    <div className="slide flex items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Integrating seamlessly with various platforms, ContentCrafter AI
